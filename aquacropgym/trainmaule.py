...
from aquacropenv import Aquaenv, maule_grape_config
...
gendf = calc_eto_faopm('data/MauleWG.dat', 1995, -35.4, 102, True, ["simyear", "jday", "minTemp", "maxTemp", "precip", "rad"])
gendf.head()
...
DAYS_TO_IRR = 3 # 'number of days between irrigation decisions (e.g., 1, 3, 5, 7)
envconfig = maule_grape_config.copy() # get default config dictionary
